...
export const SWATCH_COLOR_CODES = {
  ...
  'BLACK + WHITE NS WH 15/PE': WHITE_NS_WH,
  'BLACK + YELLOW DL YE 78/PE': YELLOW_DL_YE,
  'BLACK + RED DL RD 34/PE': RED_DL_RD,
  'BLACK + GREEN DL GR 84/PE': GREEN_DL_GR,
  'BLACK + GREEN DL GR 31': GREEN_DL,
  'BLACK + SILVER DL YE 45/M/PEG': SILVER_DL_YE,
  'BLACK + SILVER LC RD 30/M/PE': SILVER_LC_RD,
  'BLACK + BROWN NS BW 87/M/PM': BROWN_NS_BW,
  'BLACK + SILVER AT BG 50/M/PE': SILVER_AT_BG,
